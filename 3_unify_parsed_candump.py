...
def process_file(input_filename, file_ref):
    ...
    print(f"Combining file {input_filename} with {file_ref} from {start} to {end}, exporting to {file_out}.")
...
def main2020():
    ...
    input_file_list += sorted(glob(input_path + 'candump-2020-01-29_115602.log_chunk_*.hdf5'))
    input_file_list += sorted(glob(input_path + 'candump-2020-01-30_054738.log_chunk_*.hdf5'))
    input_file_list += sorted(glob(input_path + 'candump-2020-01-30_172000.log_chunk_*.hdf5'))
    input_file_list += sorted(glob(input_path + 'candump-2020-02-01_064223.log_chunk_*.hdf5'))
    input_file_list += sorted(glob(input_path + 'candump-2020-02-01_064222.log_chunk_*.hdf5'))
